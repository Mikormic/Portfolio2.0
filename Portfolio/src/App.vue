<template>
  <main>
    <RouterLink to="/">
      <img v-if="showArrow" class="arrow" src="../src/assets/icons/vers-le-haut.png" alt="" srcset="">
    </RouterLink>
      ...
      <div :style="{ opacity: titleOpacity }">
        ...
        <ul class="animate__animated" :class="{ 'animate__animated animate__backInUp': Animations }">
          ...
          <li style="display: flex; flex-direction: row;">
            <a style="margin-right: 1%;" href="https://www.linkedin.com/in/micka%C3%ABl-lesueur-4748a5201/"><v-img
                width="30" src="@/assets/icons/icons8-linkedin-50.png"></v-img></a>
            <a href="https://github.com/Mikormic/Portfolio2.0"><v-img width="30"
                src="@/assets/icons/icons8-git-50.png"></v-img></a>
          </li>
        </ul>
      </div>
    </v-container>
